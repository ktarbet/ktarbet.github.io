...
function getRandomQuestion()
{
 ...
 var q = workingQuestions.filter(function(elem, index, array) {
       ...
       && (
        ...
        ||     elem.level === "novice" && novice.checked
        ||     elem.level === "jr bonus" && jrbonus.checked
        ||     elem.level === "sr bonus" && srbonus.checked
        ||     elem.level === "int bonus" && intbonus.checked
        ||     elem.level === "intermediate" && intermediate.checked
